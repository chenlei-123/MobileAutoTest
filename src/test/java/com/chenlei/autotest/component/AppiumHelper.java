package com.chenlei.autotest.component;
...
public class AppiumHelper {
     ...
     * @throws
     */
    public static IOSDriver initDriver(IOSDriver driver) throws MalformedURLException {
        System.out.println("======init driver=====");
        DesiredCapabilities cap = new DesiredCapabilities();
        cap.setCapability(MobileCapabilityType.AUTOMATION_NAME, "XCUITest");//匹配iOS10+xcode8+appium1.6.3
        cap.setCapability(MobileCapabilityType.APPIUM_VERSION, "1.6.4-beta");

        //真机:UUID APP为bundleID;其他四项与模拟器一样
        cap.setCapability(MobileCapabilityType.UDID, "0c32c82dba15393e374819e89c3412c5adbf7022");
        ...
        cap.setCapability(MobileCapabilityType.APP, "com.renrenxing.JDB");
        cap.setCapability("sessionOverride", false);
        cap.setCapability("backendRetries", 3);

        //cap.setCapability("noReset",true);
        driver = new IOSDriver(new URL("http://" + "127.0.0.1:4723" + "/wd/hub"),
                cap);

        driver.manage().timeouts().implicitlyWait(15000000, TimeUnit.MICROSECONDS);
        return driver;
    }
...
//        Reporter.log("<p><img width=\"256\" src=\"" + file.getAbsoluteFile() + "\" alt=\"screenshot at " + new Date() + "\"/></p></a><br/>");
        ...
        String jenkinsPicturePath = "http://client-jenkins.jdb-dev.com:8080/job/FaultTolerantAndroidFriend/ws/snapshot/picture/";
        if(systemName.equals("Mac OS X")){
